...
public class CouncilCulturalSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass danceSecy=new CouncilUserClass("Yash Doshi","Institute Dance Secretary",""," 160020001@iitdh.ac.in",R.drawable.office_worker);
        CouncilUserClass filmSecy=new CouncilUserClass("Gautam Jagdhish","Institute Film and Media Secretary",""," 170010031@iitdh.ac.in",R.drawable.office_worker);
        CouncilUserClass musicSecy=new CouncilUserClass("Saurav Nitin Dosi","Institute Music Secretary","","170030006@iitdh.ac.in",R.drawable.office_worker);
        CouncilUserClass artSecy=new CouncilUserClass("Deeksha N","Institute Fine Arts Secretary","","160010033@iitdh.ac.in",R.drawable.office_worker);
