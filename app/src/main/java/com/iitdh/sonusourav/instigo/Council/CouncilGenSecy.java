...
public class CouncilGenSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass genAcSecy=new CouncilUserClass("Shruti Patel","Academic General Secretary",""," 160010002@iitdh.ac.in",R.drawable.office_worker);
        CouncilUserClass genCulSecy=new CouncilUserClass("Mehul Bose","Cultural General Secretary",""," 170030010@iitdh.ac.in",R.drawable.office_worker);
        CouncilUserClass genTechSecy=new CouncilUserClass("Samveed Desai","Technical General Secretary",""," 160020003@iitdh.ac.in",R.drawable.office_worker);
        CouncilUserClass genSportSecy=new CouncilUserClass("Nikhilesh Kumar Thakur","Sports General Secretary",""," 160030024@iitdh.ac.in",R.drawable.office_worker);
